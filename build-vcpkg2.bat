...
echo ========================================
echo Installing ALL required Boost libraries
echo ========================================
cd /d C:\vcpkg
vcpkg install boost-asio:x64-windows boost-variant:x64-windows

if errorlevel 1 exit /b 1

echo.
echo ========================================
echo Building ur_rtde (attempt 2)
echo ========================================
cd /d C:\Users\lasaths\Github\UR.RTDE\build-native\ur_rtde\build
